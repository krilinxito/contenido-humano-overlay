...
export function Tema() {
  ...
  const label = useOverlayStore((s) => s.texts['tema-label']);
  const windowTitle = useOverlayStore((s) => s.texts['tema-window']);
  return (
    <motion.div
    ...
    >
      <ScreenPlusCams screenLabel="VISUALES DEL TEMA" windowTitle={windowTitle} screen="screen-productor" />
      ...
      >
        <span className="tema__titulo-hoy">{label}</span>
